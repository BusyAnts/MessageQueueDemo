...
public class ConsumerHeaderSms {
    ...
    private static final String EXCHANGE_HEADERS_INFO = "exchange_header_info";
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        //headers_email.put("info_email", "sms");
        //channel.queueBind(QUEUE_INFO_SMS, EXCHANGE_HEADERS_INFO, "", headers_email);
        //定义消费方法
